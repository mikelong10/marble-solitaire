 ...
 * MarbleSolitaireAbstractFactory interface. This class can create EuropeanSolitaireModel objects
...
public class EuropeanSolitaireFactory implements MarbleSolitaireAbstractFactory {
  ...
  /**
   * Creates an EuropeanSolitaireFactory object, which initializes an EuropeanSolitaireModel
   ...
   */
  public EuropeanSolitaireFactory(int size, int holeRow, int holeCol) {
    this.model = new EuropeanSolitaireModel(size, holeRow, holeCol);
  }
